...
// import { concertEvents, photographerInfo } from "@/data/portfolio";
// import { Camera, MapPin, Calendar, ArrowRight } from "lucide-react";

// export default function Home() {
//   const featuredEvents = concertEvents.slice(0, 3);
...
//             <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
//               Trusted by Amsterdam's most prestigious music venues
//             </p>
//           </motion.div>
